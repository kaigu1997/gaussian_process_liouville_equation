...
const int NumElement = NumPES * NumPES; ///< The number of elements of matrices in quantum degree (e.g. H, rho)
...
using Tensor3d = Eigen::Matrix<QuantumDoubleMatrix, PhaseDim, 1>;
